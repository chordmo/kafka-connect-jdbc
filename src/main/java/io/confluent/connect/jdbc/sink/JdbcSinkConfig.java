...
public class JdbcSinkConfig extends AbstractConfig {
        ...
        public static final List<String> DEFAULT_KAFKA_PK_NAMES =
                        Collections.unmodifiableList(Arrays.asList("__connect_topic",
                                        "__connect_partition", "__connect_offset"));
        ...
        public static final String CONNECTION_USER =
                        JdbcSourceConnectorConfig.CONNECTION_USER_CONFIG;
        ...
        private static final String PK_MODE_DOC = "The primary key mode, also refer to ``"
                        + PK_FIELDS + "`` documentation for interplay. " + "Supported modes are:\n"
                        + "``none``\n" + "    No keys utilized.\n" + "``kafka``\n"
        ...
        private static final ConfigDef.Range NON_NEGATIVE_INT_VALIDATOR =
        ...
        public static final ConfigDef CONFIG_DEF = new ConfigDef()
                        ...
                        .define(TABLE_NAME_FORMAT, ConfigDef.Type.STRING, TABLE_NAME_FORMAT_DEFAULT,
                                        ...
                                        DATAMAPPING_GROUP, 1, ConfigDef.Width.LONG,
                                        TABLE_NAME_FORMAT_DISPLAY)
                        .define(TABLE_NAME_REPLACE_TARGET, ConfigDef.Type.STRING,
                                        TABLE_NAME_REPLACE_TARGET_DEFAULT,
                                        ConfigDef.Importance.MEDIUM, TABLE_NAME_REPLACE_TARGET_DOC,
                                        DATAMAPPING_GROUP, 1, ConfigDef.Width.LONG,
                                        TABLE_NAME_REPLACE_TARGET_DISPLAY)
                        .define(TABLE_NAME_REPLACE_REPLACEMENT, ConfigDef.Type.STRING,
                                        TABLE_NAME_REPLACE_REPLACEMENT_DEFAULT,
                                        ConfigDef.Importance.MEDIUM,
                                        TABLE_NAME_REPLACE_REPLACEMENT_DOC, DATAMAPPING_GROUP, 1,
                                        ConfigDef.Width.LONG,
                                        TABLE_NAME_REPLACE_REPLACEMENT_DISPLAY)
                        .define(PK_MODE, ConfigDef.Type.STRING, PK_MODE_DEFAULT,
                                        EnumValidator.in(PrimaryKeyMode.values()),
                                        ConfigDef.Importance.HIGH, PK_MODE_DOC, DATAMAPPING_GROUP,
                                        2, ConfigDef.Width.MEDIUM, PK_MODE_DISPLAY)
                        .define(PK_FIELDS, ConfigDef.Type.LIST, PK_FIELDS_DEFAULT,
                                        ConfigDef.Importance.MEDIUM, PK_FIELDS_DOC,
                                        DATAMAPPING_GROUP, 3, ConfigDef.Width.LONG,
                                        PK_FIELDS_DISPLAY)
                        .define(FIELDS_WHITELIST, ConfigDef.Type.LIST, FIELDS_WHITELIST_DEFAULT,
                                        ConfigDef.Importance.MEDIUM, FIELDS_WHITELIST_DOC,
                                        DATAMAPPING_GROUP, 4, ConfigDef.Width.LONG,
                                        FIELDS_WHITELIST_DISPLAY)
                        .define(DB_TIMEZONE_CONFIG, ConfigDef.Type.STRING, DB_TIMEZONE_DEFAULT,
                                        TimeZoneValidator.INSTANCE, ConfigDef.Importance.MEDIUM,
                                        DB_TIMEZONE_CONFIG_DOC, DATAMAPPING_GROUP, 5,
                                        ConfigDef.Width.MEDIUM, DB_TIMEZONE_CONFIG_DISPLAY)
                        // DDL
                        ...
                        .define(QUOTE_SQL_IDENTIFIERS_CONFIG, ConfigDef.Type.STRING,
                                        QUOTE_SQL_IDENTIFIERS_DEFAULT, ConfigDef.Importance.MEDIUM,
                                        QUOTE_SQL_IDENTIFIERS_DOC, DDL_GROUP, 3,
                                        ConfigDef.Width.MEDIUM, QUOTE_SQL_IDENTIFIERS_DISPLAY,
                                        QUOTE_METHOD_RECOMMENDER)
                        // Retries
                        .define(MAX_RETRIES, ConfigDef.Type.INT, MAX_RETRIES_DEFAULT,
                                        NON_NEGATIVE_INT_VALIDATOR, ConfigDef.Importance.MEDIUM,
                                        MAX_RETRIES_DOC, RETRIES_GROUP, 1, ConfigDef.Width.SHORT,
                                        MAX_RETRIES_DISPLAY)
                        .define(RETRY_BACKOFF_MS, ConfigDef.Type.INT, RETRY_BACKOFF_MS_DEFAULT,
                                        NON_NEGATIVE_INT_VALIDATOR, ConfigDef.Importance.MEDIUM,
                                        RETRY_BACKOFF_MS_DOC, RETRIES_GROUP, 2,
        ...
        public JdbcSinkConfig(Map<?, ?> props) {
                ...
                tableNameReplaceTarget = getString(TABLE_NAME_REPLACE_TARGET).trim();
                tableNameReplaceReplacement = getString(TABLE_NAME_REPLACE_REPLACEMENT).trim();
