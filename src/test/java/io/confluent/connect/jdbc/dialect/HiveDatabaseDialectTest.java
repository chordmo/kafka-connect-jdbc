...
public class HiveDatabaseDialectTest extends BaseDialectTest<MySqlDatabaseDialect> {
  ...
  @Test
  public void re() {
    String aa = "testhivedrivertable.key.bbbb";
    String cc = aa.replace("testhivedrivertable.", "");
    System.out.println(cc);
  }
  @Test
  public void sub() {
    String aa = "testhivedrivertable.key.bbbb";
    String cc = aa.substring("testhivedrivertable.".length());
    System.out.println(cc);
  }
}
